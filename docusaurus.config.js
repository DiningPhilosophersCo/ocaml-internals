...
const config = {
  ...
  tagline: "Notes about OCaml compiler's internals",
  favicon: "img/favicon.ico",

  // Set the production url of your site here
  url: "https://ocaml-internals.dining-philosophers.dev",
  ...
  projectName: "ocaml-internals", // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            "https://github.com/DiningPhilosophersCo/ocaml-internals/tree/main/",
        },
        theme: {
  ...
  themeConfig:
    ...
    ({
      ...
      image: "img/ocaml-internals-social-card.jpg",
      navbar: {
        title: "OCaml Internals",
        logo: {
